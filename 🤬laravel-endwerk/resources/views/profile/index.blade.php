        ...
        <div class="col-span-4 grid gap-4">
            ...
            <div class="p-4 bg-gray-100 flex items-center justify-between relative">
                <div>
                    ...
                    <p class="text-gray-500">{{ isset($favoritesCount) ? $favoritesCount : 0 }} product{{ isset($favoritesCount) && $favoritesCount !== 1 ? 'en' : '' }}</p>
                </div>
                <div class="text-4xl">
                    <i class="fa-solid fa-angle-right"></i>
                </div>
            ...
            <div class="p-4 bg-gray-100 flex items-center justify-between relative">
                <div>
                    ...
                    <p class="text-gray-500">{{ isset($orderCount) ? $orderCount : 0 }} bestelling{{ isset($orderCount) && $orderCount !== 1 ? 'en' : '' }}</p>
                </div>
                <div class="text-4xl">
                    <i class="fa-solid fa-angle-right"></i>
                </div>
